...
class TestEvalColumns(unittest.TestCase):
    ...
    def test_zeros(self):
        self.assertEqual(evalColumns([[empty]*3]*3, values_1), [3, 3, 3])
    ...
    def test_random_state_0(self):
        ...
        columns = [[player1, empty, opponent2],
                   ...
                   [empty, empty, player1]]
        self.assertEqual(evalColumns(columns, values_1), [2, 1, 4])
    ...
    def test_random_state_1(self):
        ...
        self.assertEqual(evalColumns(columns, values_2), [1, 4, 2])
